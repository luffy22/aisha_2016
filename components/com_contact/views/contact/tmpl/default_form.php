...
<form role="form" id="contact-form" action="<?php echo JRoute::_('index.php'); ?>" method="post" class="form-validate form-horizontal">
    ...
    <div class="form-group">
            ...
            <div class="form-control"><?php echo $this->form->getInput('contact_name'); ?></div>
    </div>
    <div class="form-group">
            <label><?php echo $this->form->getLabel('contact_email'); ?></label>
            <div class="form-control"><?php echo $this->form->getInput('contact_email'); ?></div>
    </div>
    <div class="form-group">
            <label><?php echo $this->form->getLabel('contact_subject'); ?></label>
            <div class="form-control"><?php echo $this->form->getInput('contact_subject'); ?></div>
    </div>
    <div class="form-group">
            <label><?php echo $this->form->getLabel('contact_message'); ?></label>
            <div class="form-control"><?php echo $this->form->getInput('contact_message'); ?></div>
    </div>
			<?php if ($this->params->get('show_email_copy')) { ?>
				<div class="control-group">
					<label><?php echo $this->form->getLabel('contact_email_copy'); ?></label>
					<div class="form-control"><?php echo $this->form->getInput('contact_email_copy'); ?></div>
				</div>
			<?php } ?>
