...
class modRatingBestHelper
{
    ...
    public function showArticles()
    {
        ...
        $query          = "SELECT jv_content.id AS article_id, jv_content.alias as article_alias,
                        jv_content.asset_id AS article_assetid,jv_content.title, 
                         jv_categories.alias AS cat_alias, jv_categories.title as cat_title, jv_content.catid FROM jv_content INNER JOIN jv_categories
